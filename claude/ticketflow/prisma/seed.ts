...
const AGENTS = [
  ...
  { name: "Arjun Mehta", email: "arjun@agentsupport.test", role: "ADMIN" as const, team: "Billing" },
  { name: "Sara Iyer", email: "sara@agentsupport.test", role: "AGENT" as const, team: "Tech support" },
];
